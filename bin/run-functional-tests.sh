...
export EDITORUSERNAME=${EDITOR_USERNAME}
export EDITORPASSWORD=${EDITOR_PASSWORD}
export APPROVERUSERNAME=${APPROVER_USERNAME}
export APPROVERPASSWORD=${APPROVER_PASSWORD}
