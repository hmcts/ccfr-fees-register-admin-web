...
export EDITORUSERNAME=${EDITORUSERNAME}
export EDITORPASSWORD=${EDITORPASSWORD}
export APPROVERUSERNAME=${APPROVERUSERNAME}
export APPROVERPASSWORD=${APPROVERPASSWORD}
