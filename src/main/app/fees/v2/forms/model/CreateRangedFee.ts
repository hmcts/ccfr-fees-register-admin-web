...
export class CreateRangedFee {
  ...
  createRangedFeeDto (dto): CreateFeeDto {
    ...
    const createFeeDto = new CreateRangedFeeDto()
    ...
    createFeeDto.min_range = dto.rangeFrom
    createFeeDto.max_range = dto.rangeTo
