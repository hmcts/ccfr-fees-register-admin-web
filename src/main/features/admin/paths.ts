...
export class Paths {
  ...
  static readonly unsecuredViewFees = new RoutablePath('/view-fees', 'admin/v2/views/all-fees')
  static readonly unsecuredViewFeeVersionHistory = new RoutablePath('/view-fee-version-history/:feeCode', 'admin/v2/views/fee')
