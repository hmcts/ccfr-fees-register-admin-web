...
export default express.Router()
  .get(Paths.createFeeVersionPageV2.uri,
    validateFeeParams([{ source: 'query', name: 'version' }]),
  ...
  .post(Paths.createFeeVersionPageV2.uri,
    validateFeeParams([{ source: 'query', name: 'version' }]),
    FormValidator.requestHandler(CreateFeeVersionForm, CreateFeeVersionForm.fromObject), (req: express.Request, res: express.Response) => {
