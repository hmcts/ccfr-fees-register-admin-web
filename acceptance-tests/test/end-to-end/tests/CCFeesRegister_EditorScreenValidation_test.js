...
Scenario('@functional FeesRegister Admin Console Editor Screen For Live Fees Details', async ({ I }) => {
  ...
  if (CONF.e2e.frontendUrl.includes("aat")) {
    I.verifyFeeDetails('live', 'FEE0002','1.2','Family Proceedings Fees Order 2008','divorce','issue','Filing an application for a divorce, nullity or civil partnership dissolution',
      '2026 No 568','The Court and Tribunal Fees (Miscellaneous Amendments) 2026','family','family court','fixed','Flat','628.00','',
      '06 July 2026', '', '9', 'Inflationary Increases', '4481102159', 'RECEIPT OF FEES - Family issue divorce', 'enhanced', 'all', 'DivorceCivPart', 'default', 'approved', 'The user\'s details are unavailable', 'pkiauq puuujbhe');
  } else if (CONF.e2e.frontendUrl.includes("demo")) {
    I.verifyFeeDetails('live', 'FEE0002','1.2','Family Proceedings Fees Order 2008','divorce','issue','Filing an application for a divorce, nullity or civil partnership dissolution',
      '2026 No 568','The Court and Tribunal Fees (Miscellaneous Amendments) 2026','family','family court','fixed','Flat','628.00','',
      '06 July 2026', '', '9', 'Inflationary Increases', '4481102159', 'RECEIPT OF FEES - Family issue divorce', 'enhanced', 'all', 'DivorceCivPart', 'default', 'approved', 'The user\'s details are unavailable', 'TOTO TOTO');
  }
  I.click('Sign out');
}).retry(CCFRATConstants.retryScenario);
...
Scenario('@functional FeesRegister Verify Version details for existing fee',  async ({ I }) => {
  ...
  if (CONF.e2e.frontendUrl.includes("aat")) {
    I.verifyCurrentFeeVersion('5', 'Previously: 4', 'Filing an application for a divorce, nullity or civil partnership dissolution', 'Previously: Filing an application for a divorce, nullity or civil partnership dissolution – fees order 1.2.',
      ...
      'The user\'s details are unavailable', 'Previously:', 'pkiauq puuujbhe', 'Previously:', 'FEE0002', 'divorce', 'issue', 'family', 'family court', 'fixed', 'Flat', 'all', '', 'default', '550', '1.2', '', '', 'The Civil Proceedings, Family Proceedings and Upper Tribunal Fees (Amendment) Order 2016',
